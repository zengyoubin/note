...
```
by bike 骑自行车 by bus 乘公车 by train 坐火车 by plane /air 乘飞机
by ship/boat 乘船/小船 by land/sea 由陆路/海路
```

##### 如果一个名词前面已经有形容词性物主代词,名词所有格`‘s`,指示代词,疑问词以及 `some,little,both,each,either,few,a few,a little,any ,no,another,every,much ,many` 等不定代词作定 语的时候不可以用冠词
...
​	在某些习惯用语中，用还是不用冠词，意义不同，有时候甚至差别很大，使用时要特别。
